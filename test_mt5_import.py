...
# Ścieżka do pliku konfiguracyjnego z danymi do logowania (możesz zmieniać na inne profile)
...
if not mt5.initialize(**init_kwargs):
    ...
    # Sprawdź konto i podstawowe informacje
    info = mt5.account_info()
    print("Konto:", info)

    # Prosty test pobrania ticka
    if symbol:
